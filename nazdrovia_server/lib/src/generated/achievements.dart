...
abstract class Achievement implements _i1.TableRow, _i1.ProtocolSerialization {
  ...
  static AchievementInclude include({
    _i2.AchievementCategoryInclude? category,
    _i2.CompletedAchievementsIncludeList? playersWithAchievement,
  }) {
...
class AchievementTable extends _i1.Table {
  ...
  _i2.AchievementCategoryTable? _category;

  late final _i1.ColumnString image;

  _i2.CompletedAchievementsTable? ___playersWithAchievement;

  _i1.ManyRelation<_i2.CompletedAchievementsTable>? _playersWithAchievement;

  late final _i1.ColumnInt displayOrder;

  _i2.AchievementCategoryTable get category {
    ...
    _category = _i1.createRelationTable(
      ...
      foreignField: _i2.AchievementCategory.t.id,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
          _i2.AchievementCategoryTable(tableRelation: foreignTableRelation),
    );
    return _category!;
  }

  _i2.CompletedAchievementsTable get __playersWithAchievement {
    ...
    ___playersWithAchievement = _i1.createRelationTable(
      ...
      foreignField: _i2.CompletedAchievements.t.achievementId,
      tableRelation: tableRelation,
      createTable: (foreignTableRelation) =>
  ...
  _i1.ManyRelation<_i2.CompletedAchievementsTable> get playersWithAchievement {
    ...
    _playersWithAchievement = _i1.ManyRelation<_i2.CompletedAchievementsTable>(
...
class AchievementInclude extends _i1.IncludeObject {
  ...
  _i2.AchievementCategoryInclude? _category;

  _i2.CompletedAchievementsIncludeList? _playersWithAchievement;
...
class AchievementAttachRepository {
  ...
  Future<void> playersWithAchievement(
    ...
    await session.db.update<_i2.CompletedAchievements>(
      ...
      columns: [_i2.CompletedAchievements.t.achievementId],
      transaction: transaction ?? session.transaction,
    );
  }
}
