...
import 'package:nazdrovia_flutter/src/features/admin/presentation/admin_app_bar.dart';
...
class AdminRuleListScreen extends ConsumerWidget {
  const AdminRuleListScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AdminAppBar(title: context.tr.rules),
      body: AsyncValueWidget<List<RuleCategory>>(
